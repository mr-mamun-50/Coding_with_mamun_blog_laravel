                ...
                <div class="mb-5 col-lg-8 mb-lg-0">
                    ...
                    <article class="mb-4 card">
                        <div class="post-slider">
                            <img src="{{ asset('usr_assets/images/post/post-10.jpg') }}" class="card-img-top" alt="post-thumb">
                            <img src="{{ asset('usr_assets/images/post/post-1.jpg') }}" class="card-img-top"
                                alt="post-thumb">
                        </div>
                        <div class="card-body">
                    ...
                    <article class="mb-4 card">
                        <div class="post-slider">
                            <img src="{{ asset('usr_assets/images/post/post-3.jpg') }}" class="card-img-top"
                                alt="post-thumb">
                        </div>
                        <div class="card-body">
                    ...
                    <article class="mb-4 card">
                        <div class="post-slider">
                            <img src="{{ asset('usr_assets/images/post/post-7.jpg') }}" class="card-img-top"
                                alt="post-thumb">
                        </div>
                    ...
                    <article class="mb-4 card">
                        <div class="card-body">
                            ...
                            <ul class="card-meta list-inline">
                                <li class="list-inline-item">
                                    <a href="author-single.html" class="card-meta-author">
                                        <img src="{{ asset('usr_assets/images/kate-stone.jpg') }}" alt="Kate Stone">
                    ...
                    <article class="mb-4 card">
                        <div class="post-slider">
                            <img src="{{ asset('usr_assets/images/post/post-5.jpg') }}" class="card-img-top"
                                alt="post-thumb">
                        </div>
                        <div class="card-body">
                    ...
                    <article class="mb-4 card">
                        <div class="post-slider">
                            <img src="{{ asset('usr_assets/images/post/post-8.jpg') }}" class="card-img-top"
                                alt="post-thumb">
                            <img src="{{ asset('usr_assets/images/post/post-9.jpg') }}" class="card-img-top"
                                alt="post-thumb">
                        </div>
                        <div class="card-body">
                            <h3 class="mb-3"><a class="post-title" href="post-details.html">How To Make Cupcakes
