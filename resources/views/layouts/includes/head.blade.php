<head>
    ...
    <!--Favicon-->
    <link rel="shortcut icon" href="{{ asset('usr_assets/images/favicon.png') }}" type="image/x-icon">
    <link rel="icon" href="{{ asset('usr_assets/images/favicon.png') }}" type="image/x-icon">
