<aside class="col-lg-4 sidebar-home">
    ...
    <!-- Promotion -->
    <div class="promotion">
        <img src="{{ asset('usr_assets/images/promotion.jpg') }}" class="img-fluid w-100">
        <div class="promotion-content">
            <h5 class="mb-3 text-white">Create Stunning Website!!</h5>
            <p class="mb-4 text-white">Lorem ipsum dolor sit amet, consectetur sociis. Etiam nunc amet
    ...
    <div class="widget widget-author">
        ...
        <div class="media align-items-center">
            <div class="mr-3">
                <img class="widget-author-image" src="{{ asset('usr_assets/images/john-doe.jpg') }}">
            </div>
        ...
        <div class="media align-items-center">
            <div class="mr-3">
                <img class="widget-author-image" src="{{ asset('usr_assets/images/kate-stone.jpg') }}">
            </div>
            <div class="media-body">
        ...
        <div class="media align-items-center">
            <div class="mr-3">
                <img class="widget-author-image" src="{{ asset('usr_assets/images/john-doe.jpg') }}" alt="John Doe">
            </div>
            <div class="media-body">
    ...
    <div class="widget">
        ...
        <article class="widget-card">
            <div class="d-flex">
                <img class="card-img-sm" src="{{ asset('usr_assets/images/post/post-10.jpg') }}">
                <div class="ml-3">
        ...
        <article class="widget-card">
            <div class="d-flex">
                <img class="card-img-sm" src="{{ asset('usr_assets/images/post/post-3.jpg') }}">
                <div class="ml-3">
        ...
        <article class="widget-card">
            <div class="d-flex">
                <img class="card-img-sm" src="{{ asset('usr_assets/images/post/post-7.jpg') }}">
                <div class="ml-3">
                    <h5><a class="post-title" href="post-details.html">Advice From a Twenty
                            Something</a></h5>
                    <ul class="mb-0 card-meta list-inline">
